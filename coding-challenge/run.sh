...
python ./src/rolling_median.py ./insight_testsuite/tests/test-1-venmo-trans/venmo_input/venmo-trans.txt ./insight_testsuite/tests/test-1-venmo-trans/venmo_output/output.txt